...
import com.ml.kafka.stream.processor.period.EtlEnergyHourlyProcessor;

public class EtlEnergyHourly {
static final String hourlyStateStoreName = "etl-energy-hourly-store";
    ...
    public static void main(final String[] args) {
        ...
        final String sink_name = "kafka-etl-energy-hourly";
        ...
        stream
                ...
                .process(() -> new EtlEnergyHourlyProcessor(hourlyStateStoreName),
                        hourlyStateStoreName)
                .map((key, value) -> {
