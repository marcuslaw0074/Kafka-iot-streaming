...
const TableNameEkuiperCalculation = "ekuiperCalculation"

// EkuiperCalculation mapped from table <ekuiperCalculation>
type EkuiperCalculation struct {
...
// TableName EkuiperCalculation's table name
func (*EkuiperCalculation) TableName() string {
	return TableNameEkuiperCalculation
}
