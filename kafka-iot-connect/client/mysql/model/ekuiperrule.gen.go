...
const TableNameEkuiperRule = "ekuiperRule"

// EkuiperRule mapped from table <ekuiperRule>
...
// TableName EkuiperRule's table name
func (*EkuiperRule) TableName() string {
	return TableNameEkuiperRule
}
